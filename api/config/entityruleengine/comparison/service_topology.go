...
import (
	...
	"github.com/dtcookie/dynatrace/api/config/entityruleengine/comparison/service_topology"
...
func (stc *ServiceTopology) Schema() map[string]*hcl.Schema {
...
func (stc *ServiceTopology) MarshalHCL() (map[string]interface{}, error) {
