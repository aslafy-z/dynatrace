...
import (
	...
	"github.com/dtcookie/dynatrace/api/config/entityruleengine/comparison/application_type"
...
func (atc *ApplicationType) Schema() map[string]*hcl.Schema {
...
func (atc *ApplicationType) MarshalHCL() (map[string]interface{}, error) {
