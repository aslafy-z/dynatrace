...
import (
	...
	"github.com/dtcookie/dynatrace/api/config/entityruleengine/comparison/database_topology"
...
func (dtc *DatabaseTopology) Schema() map[string]*hcl.Schema {
...
func (dtc *DatabaseTopology) MarshalHCL() (map[string]interface{}, error) {
