...
import (
	...
	"github.com/dtcookie/dynatrace/api/config/entityruleengine/comparison/ostype"
...
func (otc *OSType) Schema() map[string]*hcl.Schema {
...
func (otc *OSType) MarshalHCL() (map[string]interface{}, error) {
