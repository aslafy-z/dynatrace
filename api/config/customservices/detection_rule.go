...
type DetectionRule struct {
	...
	FileName         string           `json:"fileName"`                  // The PHP file containing the class or methods to instrument. Required for PHP custom service. Not applicable to Java and .NET
