...
import (
	...
	"github.com/dtcookie/dynatrace/api/config/managementzones/comparison"
	"github.com/dtcookie/dynatrace/api/config/managementzones/condition"
...
func (erec *EntityRuleEngineCondition) Schema() map[string]*hcl.Schema {
...
func (erec *EntityRuleEngineCondition) MarshalHCL() (map[string]interface{}, error) {
...
func (erec *EntityRuleEngineCondition) UnmarshalHCL(decoder hcl.Decoder) error {
