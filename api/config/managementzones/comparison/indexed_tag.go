...
import (
	...
	"github.com/dtcookie/dynatrace/api/config/managementzones/comparison/indexed_tag"
	"github.com/dtcookie/dynatrace/api/config/managementzones/comparison/tag"
