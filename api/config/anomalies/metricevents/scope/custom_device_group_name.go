...
func (me *CustomDeviceGroupName) GetType() FilterType {
	return FilterTypes.CustomDeviceGroupName
}

func (me *CustomDeviceGroupName) Schema() map[string]*hcl.Schema {
...
func (me *CustomDeviceGroupName) MarshalHCL(decoder hcl.Decoder) (map[string]interface{}, error) {
