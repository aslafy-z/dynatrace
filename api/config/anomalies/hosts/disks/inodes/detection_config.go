...
// DetectionConfig Configuration of low disk inodes number detection.
type DetectionConfig struct {
	CustomThresholds *Thresholds `json:"customThresholds,omitempty"` // Custom thresholds for low disk inodes number. If not set, automatic mode is used.
