...
// DetectionConfig Configuration of slow running disks detection.
type DetectionConfig struct {
	CustomThresholds *Thresholds `json:"customThresholds,omitempty"` // Custom thresholds for slow running disks. If not set, the automatic mode is used.
