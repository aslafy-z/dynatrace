...
// DetectionConfig Configuration of Java out of memory problems detection.
type DetectionConfig struct {
	CustomThresholds *Thresholds `json:"customThresholds,omitempty"` // Custom thresholds for Java out of memory. If not set, automatic mode is used.
