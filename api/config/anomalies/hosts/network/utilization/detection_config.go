...
// DetectionConfig Configuration of high network utilization detection.
type DetectionConfig struct {
	CustomThresholds *Thresholds `json:"customThresholds,omitempty"` // Custom thresholds for high network utilization. If not set, automatic mode is used.
