...
// DetectionConfig Configuration of high CPU saturation detection
type DetectionConfig struct {
	CustomThresholds *Thresholds `json:"customThresholds,omitempty"` // Custom thresholds for high CPU saturation. If not set then the automatic mode is used.
